        ...
        <header>     
            <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-gray-900 dark:border-b-1">
              ...
              to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                  <img src="assets\\logo2.png" className="h-8" alt=" Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Movie-con</span>
              </Link>
          ...
          <div className="flex md:order-2"> 
            <button type="button" onClick={()=>setDarkMode(!darkMode)} className={`${darkMode ? "hidden" : ""} text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1`}>
            ...
            <button type="button" onClick={()=>setDarkMode(!darkMode)} className={`${!darkMode ? "hidden" : ""} text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1`}>
            <svg  className="w-5 h-5 bi bi-moon"  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
